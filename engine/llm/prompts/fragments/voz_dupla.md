...
Quando interpreta, **sempre aspas DUPLAS + atribuição clara** — Lyssa murmura, "cuidado" / "cuidado," responde Tóric. Aspas duplas SEMPRE, nunca simples: é o que marca a fala do NPC na tela (o jogador que lê distingue quem fala pela cor). Engine usa nome + aspas pra trocar voz no momento certo. Combine com **NPCs são corpos** (regra acima): gesto primeiro, fala depois.
