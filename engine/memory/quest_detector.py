...
_RE_MESTRE_VET = re.compile(
    r"\[(?:FIO|CLIFFHANGER|AGENDA|LAMPEJO|CONSEQUÊNCIA|XP|POSICAO|MOV|OURO|LOOT|PERDEU|MERCADO|FIM_MERCADO|COMPANION_ADD|COMPANION_HP|COMPANION_REMOVE|FUGIU|ANCORA|VOZ|AFETO|INIMIGO_MORTO|DESCANSO)(?::|=)?[^\]]*\]"
    r"|"
    r"\[Rolagem\s+visível:[^\]]*\]",
    re.IGNORECASE,
)
